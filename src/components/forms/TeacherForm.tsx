...
const TeacherForm = ({
  ...
  useEffect(() => {
    if (state.success) {
      toast(`Professor ${type === "create" ? "criado" : "atualizado"} com sucesso!`);
      setOpen(false);
      router.refresh();
    }
  ...
  return (
    <form className={styles.form} onSubmit={onSubmit}>
      ...
      <span className={styles.sectionLabel}>Informações Pessoais</span>
      ...
      {state.error && (
        <span className={styles.error}>Algo deu errado.</span>
      )}
